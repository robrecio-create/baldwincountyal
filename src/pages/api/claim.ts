...
export const POST: APIRoute = async ({ request }) => {
  try {
    ...
    if (RESEND_API_KEY) {
      const emailBody = [
        `New CLAIM REQUEST on BaldwinCountyAL.com`,
        '',
      ...
      await fetch('https://api.resend.com/emails', {
        ...
        body: JSON.stringify({
          from: 'BaldwinCountyAL.com <noreply@contact.baldwincountyal.com>',
          to: ['hello@baldwincountyal.com'],
          subject: `New Claim Request: ${business.title} — BaldwinCountyAL.com`,
          reply_to: email,
          text: emailBody,
        }),
